        ...
        <div class="email-wrapper">
            ...
            <div class="email-body">
                ...
                <p class="message-text">
                    <span class="highlight">{{ $senderName }}</span> has sent you a document to sign.
                </p>
                
                <div class="document-card">
                    <div class="document-title">{{ $documentTitle }}</div>
                    @if($documentMessage)
                        <p class="message-text" style="margin-top: 12px; margin-bottom: 0;">{{ $documentMessage }}</p>
                    @endif
                    <p class="sender-info" style="margin-top: 12px; margin-bottom: 0;">From: {{ $senderName }}</p>
                </div>
